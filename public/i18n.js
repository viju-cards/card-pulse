...
const TRANSLATIONS = {
  en: {
    ...
    // MAINTENANCE PAGE
    maint_badge: "SYSTEM STATUS — MAINTENANCE",
    maint_h1_1: "System",
    maint_h1_2: "Upgrade",
    maint_h1_3: "In Progress",
    maint_sub: "CardPulse is currently undergoing <strong>scheduled maintenance</strong>. We'll be back online shortly with improvements under the hood. Thanks for your patience.",
    maint_console_title: "// cardpulse_deploy.log",
    maint_step_db: "database",
    maint_step_auth: "auth_service",
    maint_step_cache: "cache_layer",
    maint_step_api: "price_api",
    maint_step_deploy: "deploy_pipeline",
    maint_status_ok: "OK",
    maint_status_rebuild: "REBUILDING",
    maint_status_pause: "PAUSED",
    maint_status_run: "RUNNING",
    maint_eta: "SHORTLY",
  ...
  de: {
    ...
    // MAINTENANCE PAGE
    maint_badge: "SYSTEM-STATUS — WARTUNG",
    maint_h1_1: "System-",
    maint_h1_2: "Wartung",
    maint_h1_3: "läuft",
    maint_sub: "CardPulse wird gerade <strong>planmäßig gewartet</strong>. Wir sind in Kürze mit Verbesserungen unter der Haube wieder online. Danke für deine Geduld.",
    maint_console_title: "// cardpulse_deploy.log",
    maint_step_db: "database",
    maint_step_auth: "auth_service",
    maint_step_cache: "cache_layer",
    ...
    maint_step_deploy: "deploy_pipeline",
    maint_status_ok: "OK",
    maint_status_rebuild: "NEU AUFBAU",
    maint_status_pause: "PAUSIERT",
    maint_status_run: "LÄUFT",
    maint_eta: "BALD",
    maint_progress: "FORTSCHRITT",
