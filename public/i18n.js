...
const TRANSLATIONS = {
  en: {
    ...
    index_step1_title: "Sign Up Free",
    index_step1_desc: "Create your CardPulse account in seconds — no credit card needed to start.",
    index_step2_title: "Install & Sign In",
    index_step2_desc: "Add CardPulse from the Chrome Web Store and sign in — your account links to the extension automatically.",
    index_step3_title: "Browse Cardmarket",
    index_step3_desc: "Open any Pokémon card and live prices appear in the overlay — TCGPlayer market, all 5 conditions, EUR conversion, 30-day history.",
    ...
    // INDEX – Pricing / Overlay / CTA (added)
    index_plan_plus: "Everything in Bronze, plus:",
    index_popular: "MOST POPULAR",
    index_pricing_split: "Every plan includes live TCGPlayer prices, EUR conversion, all 5 conditions & 30-day history. Silver and up unlock Cardmarket prices per card language and the seller-location filter.",
    index_pricing_note: "Cancel anytime · 1 request = 1 card looked up · No credit card needed for Bronze",
    index_hero_trust: "Free forever plan · No credit card · Works on every Cardmarket card page from supported sets",
    index_finalcta_label: "Stop guessing",
    index_finalcta_h1: "Know the real price",
    index_finalcta_h2: "before you buy.",
    index_finalcta_sub: "Install CardPulse and see at a glance whether a Cardmarket listing is a deal or a rip-off. Free to start, no account juggling.",
    feat_tcg_prices: "Live TCGPlayer prices",
    feat_cond_hist: "5 conditions + 30-day trend",
    feat_lang_prices: "Prices by card language",
    feat_loc_filter: "Seller-location filter",
    dash_open_cm: "Open a card on Cardmarket",
    ...
    dash_redeem_title: "Redeem voucher code",
    dash_redeem_sub:   "Got a code from an invite? Unlock it here.",
    dash_redeem_btn:   "Redeem",
    ...
    // INDEX – new UI (wow redesign) additions
    idx_nav_pricing: "Pricing",
    idx_hero_cta_demo: "▶ Watch 60-sec demo",
    idx_store_chip: "Available in the Chrome Web Store",
    idx_delta_label: "Cardmarket vs. TCGPlayer",
    idx_delta_sub: "cheaper in the EU · US market +57%",
    idx_ov_allcountries: "All countries ▾",
    idx_ov_bylang: "LOWEST NM PRICE BY LANGUAGE",
    idx_ov_dash: "DASHBOARD & SUBSCRIPTION",
    idx_radar_label: "PRICE RADAR",
    idx_video_eye: "In 60 seconds",
    idx_video_h2: "See CardPulse in action",
    idx_video_sub: "From install to your first price comparison — how the extension feels in your real Cardmarket workflow.",
    index_enterprise_cta: "Get custom quote →",
    idx_feat_lang_desc: "Lowest NM price per card language, with a seller-location filter.",
    idx_feat_theme: "Light & Dark",
    idx_feat_theme_desc: "The overlay adapts seamlessly to your Cardmarket theme.",
    price_free: "Free",
    req_per_month: "requests / month",
    btn_start_free_short: "Start free",
  },
  ...
  de: {
    ...
    index_step1_title: "Kostenlos registrieren",
    index_step1_desc: "Erstelle in Sekunden dein CardPulse-Konto — für den Start ohne Kreditkarte.",
    index_step2_title: "Installieren & einloggen",
    index_step2_desc: "CardPulse aus dem Chrome Web Store hinzufügen und einloggen — dein Konto wird automatisch mit der Extension verbunden.",
    index_step3_title: "Cardmarket besuchen",
    index_step3_desc: "Öffne eine Pokémon-Karte und die Live-Preise erscheinen im Overlay — TCGPlayer-Markt, alle 5 Konditionen, EUR-Umrechnung, 30-Tage-Verlauf.",
    index_features_label: "Features",
    ...
    // INDEX – Pricing / Overlay / CTA (neu)
    index_plan_plus: "Alles aus Bronze, plus:",
    index_popular: "BELIEBTESTE WAHL",
    index_pricing_split: "Jeder Plan enthält Live-TCGPlayer-Preise, EUR-Umrechnung, alle 5 Zustände & 30-Tage-Verlauf. Ab Silver schaltest du Cardmarket-Preise nach Kartensprache und den Verkäufer-Standort-Filter frei.",
    index_pricing_note: "Jederzeit kündbar · 1 Anfrage = 1 abgefragte Karte · Für Bronze keine Kreditkarte nötig",
    index_hero_trust: "Dauerhaft kostenlos · Keine Kreditkarte · Funktioniert auf jeder Cardmarket-Kartenseite der unterstützten Sets",
    index_finalcta_label: "Schluss mit Raten",
    index_finalcta_h1: "Kenne den echten Preis",
    index_finalcta_h2: "bevor du kaufst.",
    index_finalcta_sub: "Installiere CardPulse und sieh auf einen Blick, ob ein Cardmarket-Angebot ein Schnäppchen oder Abzocke ist. Kostenlos starten, kein Account-Jonglieren.",
    feat_tcg_prices: "Live TCGPlayer-Preise",
    feat_cond_hist: "5 Zustände + 30-Tage-Trend",
    feat_lang_prices: "Preise nach Kartensprache",
    feat_loc_filter: "Verkäufer-Standort-Filter",
    dash_open_cm: "Karte auf Cardmarket öffnen",
    ...
    dash_redeem_title: "Gutscheincode einlösen",
    dash_redeem_sub:   "Code aus einer Einladung erhalten? Hier freischalten.",
    dash_redeem_btn:   "Einlösen",
    dash_ext_title: "Browser Extension",
    ...
    // INDEX – new UI (wow redesign) additions
    idx_nav_pricing: "Preise",
    idx_hero_cta_demo: "▶ 60-Sek-Demo ansehen",
    idx_store_chip: "Verfügbar im Chrome Web Store",
    idx_delta_label: "Cardmarket vs. TCGPlayer",
    idx_delta_sub: "günstiger in der EU · US-Markt +57%",
    idx_ov_allcountries: "Alle Länder ▾",
    idx_ov_bylang: "GÜNSTIGSTER NM-PREIS NACH SPRACHE",
    idx_ov_dash: "DASHBOARD & ABO",
    idx_radar_label: "PREIS-RADAR",
    idx_video_eye: "In 60 Sekunden",
    idx_video_h2: "Sieh CardPulse in Aktion",
    idx_video_sub: "Vom Installieren bis zum ersten Preisvergleich — wie sich die Erweiterung im echten Cardmarket-Alltag anfühlt.",
    index_enterprise_cta: "Angebot anfragen →",
    idx_feat_lang_desc: "Günstigster NM-Preis je Kartensprache, mit Verkäufer-Länderfilter.",
    idx_feat_theme: "Hell & Dunkel",
    idx_feat_theme_desc: "Das Overlay passt sich nahtlos an dein Cardmarket-Theme an.",
    price_free: "Kostenlos",
    req_per_month: "Abfragen / Monat",
    btn_start_free_short: "Kostenlos starten",
  }
};
